...
class MeatloafDNP extends MeatloafD64 {
	public $dos_version;
	public $disk_name;
	public $disk_id;
	public $dos_type;
	...
	function __construct( $image )
	{
		...
		if(file_exists($image) == 1)
		{
			...
			$track = ord(fread($this->fp, 1));
			$sector = ord(fread($this->fp, 1));
			$this->directory_list = Array( $track, $sector );
